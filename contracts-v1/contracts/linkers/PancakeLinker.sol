...
contract PancakeLinker is IDexLinker {
    ...
    function swap(address srcToken, address desToken, address route, uint256 srcAmount) onlyProxy external override returns (uint256) {
        ...
        uint256[] memory amounts = IPancakeRouter02(_router).swapExactTokensForTokens(srcAmount, 0, path, msg.sender, block.timestamp);
